...
BabyMock is a [visual](http://www.youtube.com/watch?v=cPbItfNc5WY) mock object library for [Pharo Smalltalk](http://www.pharo-project.org/), that supports test-driven development. Like other [mock object](http://jmock.org/) libraries, BabyMock lets you design and test the interactions between the objects in your programs. BabyMock makes these interactions visible, which can help you to get a good mental picture about the object relationships and the inter-object protocol.

BabyMock requires at least Pharo 3.0. You can use [this site](https://github.com/zeroflag/BabyMock) for reporting issues.
...
Watch [this video](https://www.youtube.com/watch?v=cPbItfNc5WY) to get an idea how does it look like in practice.
...
- Read [this paper](http://jmock.org/oopsla2004.pdf%E2%80%8E).
